          ...
          typedInstance2.current = new Typed(typedRef2.current, {
            ...
            onComplete: () => {
              ...
              typedInstance3.current = new Typed(typedRef3.current, {
                strings: [
                  "كان حمدي من النخبة المختارة في عملية تنقيب أرض سيناء الشريفة من الألغام التي تم زرعها من قبل العدو اللدود لمصرنا الحبيبة، وأصيب حمدي لكن بمهارة راوغ طلقات العدو مستبسلا في أرض المعركة ليقضي على العناصر الوحشة.",
                ],
                typeSpeed: 50,
                showCursor: true,
                cursorChar: "|",
